      ...
      <div class="left-field-content">
        ...
        <div class="left-bottom-field">
          ...
          <div class="left-bottom-content">
            <div class="tab-wrapper">
              <multi-tab
                :tabList="aDayInGuizhou"
                :tabChangeHandler="leftBottomTabChangeHandler"
              ></multi-tab>
            </div>
            <div class="day-list">
              <div
                v-for="(day, index) in aDayInGuizhouActiveData"
                :key="index"
                class="day-item"
              >
                <div class="left-icon">
...
import guizhouJson from "./guizhou";
export default {
  name: "Home",
  components: { MultiTab },
  data() {
    return {
      ...
      aDayInGuizhou: _.reverse(constants.aDayInGuizhou),
