  ...
  <div class="home-container">
    ...
    <div class="right-field">
        ...
        <div class="right-top-content">
          <div class="left-map-field">
            <div class="map-container border-icon53">
              <div id="my-map"></div>
              <div class="prompt">数据来源：国家统计局、贵州省统计局统计公报</div>
            </div>
          </div>
            ...
            <div class="tab-container">
              ...
              <div class="tab-list">
                <div class="tab-item">
                  ...
                  <div class="tab-inner-item">产值(亿元)</div>
                ...
                >
                  ...
                  <div class="tab-inner-item">{{ item.growth }}</div>
                </div>
              </div>
            </div>
            <div class="tab-container">
      ...
      <div class="right-bottom-field border-icon51">
        <div class="title-one big">
          <h5>
            <i class="point"></i> 作物详情
            <div class="prompt border-icon52">
              近20年贵州省主要作物播种面积和产量趋势图
            </div>
          </h5>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      aDayInJilin: constants.aDayInJilin,
      farmProduceData20Years: constants.farmProduceData20Years,
  ...
  methods: {
    serializeData() {
      let { labelList, valueList } = _.cloneDeep(this.farmProduceData20Years);
      let newValueList = _.cloneDeep(valueList).map((item) => {
